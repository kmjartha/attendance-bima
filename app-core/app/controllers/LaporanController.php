...
class LaporanController extends Controller
{
    ...
    public function runAlphaCheck(): string
    {
        ...
        $stats = (new Attendance())->runAlphaMarking($date);

        $this->flash('success', "Cek alpha tanggal {$date} selesai — {$stats['marked']} orang ditandai alpha. "
            . "({$stats['skipped_existing']} sudah ada baris, {$stats['skipped_leave']} sedang cuti/sakit, "
            . "{$stats['skipped_exempt']} bukan hari efektif/libur, {$stats['skipped_too_early']} belum lewat batas jam.)");
