    ...
    <div class="card-soft h-100">
      ...
      <div class="mb-2">
        <?php
          ...
          $hariPreset = [
            'Senin,Selasa,Rabu,Kamis,Jumat' => 'Senin – Jumat',
            'Senin,Selasa,Rabu,Kamis,Jumat,Sabtu' => 'Senin – Sabtu',
            'Senin,Selasa,Rabu,Kamis,Jumat,Sabtu,Minggu' => 'Setiap Hari (7 Hari)',
          ];
          $hariKey = implode(',', $hariList);
          $hariLabel = $hariPreset[$hariKey] ?? implode(', ', $hariList);
        ?>
