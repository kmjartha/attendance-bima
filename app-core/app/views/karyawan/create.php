      ...
      <div class="row g-3">
        ...
        <div class="col-md-6">
          ...
          <small class="text-muted">
            Pilih satu atau lebih shift. Pilihan pertama jadi default. Hari efektif kerja diatur per-shift di menu
            <a href="<?= url('/shift') ?>" target="_blank">Shift Kerja</a>, bukan di sini.
          </small>
        </div>
        <div class="col-md-6">
        ...
        <div class="col-md-3">
          ...
          <input type="number" name="jumlah_cuti" id="input-jumlah-cuti" value="<?= e(old('jumlah_cuti', 7)) ?>" class="form-control" min="0" max="60">
        </div>
        <div class="col-md-6">
          <label class="form-label">Jenis Karyawan</label>
          <div style="border:1px solid #e5e7eb; border-radius:8px; overflow:hidden;">
            <?php $jkOld = old('jenis_karyawan', 'kontrak'); ?>
            <label class="d-flex align-items-center justify-content-between gap-2" style="padding:.55rem .85rem; margin:0; cursor:pointer;">
              <span class="d-flex align-items-center gap-2">
                <input type="radio" name="jenis_karyawan" value="kontrak" class="form-check-input m-0" onchange="jenisKaryawanChange(this)" <?= $jkOld==='kontrak'?'checked':'' ?>>
            ...
            <label class="d-flex align-items-center justify-content-between gap-2" style="padding:.55rem .85rem; margin:0; cursor:pointer; border-top:1px solid #f1f3f5;">
              <span class="d-flex align-items-center gap-2">
                <input type="radio" name="jenis_karyawan" value="kontrak_yayasan" class="form-check-input m-0" onchange="jenisKaryawanChange(this)" <?= $jkOld==='kontrak_yayasan'?'checked':'' ?>>
